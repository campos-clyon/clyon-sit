import { useState, useRef, useEffect } from 'react' // <-- useEffect importado
...
const Orcamentos = () => {
  ...
  // Efeito para rolar para o topo quando a mensagem de sucesso aparece
  useEffect(() => {
    if (submitted) {
      window.scrollTo(0, 0);
    }
  ...
  // <-- ESTA PARTE ESTAVA FALTANDO. AGORA ESTÁ CORRETA.
  return (
