...
const Home = () => {
  const servicos = [
    ...
    },
    {
      ...
      description: "Recolha de móveis velhos e eletrodomésticos com descarte adequado.",
      image: serviceMoveis
    },
    {
  ...
  const passos = [
    {
      numero: "1",
      titulo: "Contacto",
      descricao: "Entre em contacto connosco por telefone, email ou formulário online."
    },
    {
      numero: "2",
      titulo: "Avaliação",
      descricao: "Fazemos uma avaliação do serviço e fornecemos um orçamento gratuito."
    },
    {
      numero: "3",
      titulo: "Confirmação",
    ...
    },
    {
      numero: "4",
      titulo: "Recolha",
      descricao: "Realizamos a recolha no dia agendado e recebemos o pagamento final."
    }
  ]
  ...
  const testemunhos = [
    ...
    },
    {
      nome: "Ana Costa",
      local: "Cascais",
      texto: "Precisava de recolher móveis velhos urgentemente. A CLYON resolveu no mesmo dia!",
      estrelas: 5
    }
  ]
        ...
        <div className="clyon-container">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              Serviços de recolha em Lisboa e Setúbal com compromisso ambiental e segurança
            </p>
        ...
        <div className="clyon-container">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Oferecemos soluções completas para recolha de diferentes tipos de resíduos
            </p>
          </div>
            ...
            {servicos.map((servico, index) => (
              <Card key={index} className="clyon-card-hover">
                <CardContent className="p-6 text-center">
                  {servico.image ? (
                    <img src={servico.image} alt={servico.title} className="h-24 w-24 mx-auto mb-4 rounded-lg object-cover" />
                  ) : (
      ...
      <section className="clyon-section bg-white">
        <div className="clyon-container">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Somos especialistas em recolha de resíduos com foco na qualidade e sustentabilidade
            </p>
          </div>
    ...
    <p className="text-gray-600">{vantagem.description}</p>
      ...
      <section className="clyon-section clyon-primary">
        <div className="clyon-container text-center text-white">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 text-sm">
            {['Lisboa', 'Cascais', 'Sintra', 'Oeiras', 'Amadora', 'Loures', 'Setúbal', 'Almada', 'Barreiro', 'Seixal', 'Sesimbra', 'Palmela'].map((cidade) => (
      ...
      <section className="clyon-section clyon-gradient text-white">
        <div className="clyon-container text-center">
          ...
          <p className="text-xl mb-8 opacity-90">
            Entre em contacto connosco e receba um orçamento gratuito
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
  size="lg" 
